# Generated by Django 6.0.4 on 2026-05-02 11:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PB', 'Public'), ('PV', 'Private')], default='PB', max_length=2)),
        ...
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['post', 'is_active'], name='blog_commen_post_id_039206_idx'),
        ),
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['post', 'created'], name='blog_commen_post_id_f5439e_idx'),
        ),
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['user', 'is_active'], name='blog_commen_user_id_f8c5ba_idx'),
        ),
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['user', 'created'], name='blog_commen_user_id_df23b4_idx'),
        ),
    ]
